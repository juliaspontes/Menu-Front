...
import ModalUserInsert from "../../components/User/ModalUserInsert/ModalUserInsert";
    ...
    Swal.fire({
      ...
      if (x.isConfirmed) {
        ...
        if (ret) {
          ...
          await Swal.fire(
            "Ops!",
            `Não foi possível deletar o User.<br>${error}`,
            "error"
          );
        }
      }
  ...
  return (
    <MasterPage>
      <div className="User" data-testid="User">
        <Pagebase
          title="Pagina de Usuário"
          descriptionPage="Gerenciar todos os usuários do cardápio."
